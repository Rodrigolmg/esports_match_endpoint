...
// in esports_match_endpoint/test/data/datasource/event_streak_local_datasource_test.dart.
...
import 'package:esports_match_endpoint/data/model/model.dart' as _i7;
...
///
/// See the documentation for Mockito's code generation for more information.
class MockBox extends _i1.Mock implements _i2.Box<_i7.EventStreakModel> {
  @override
  Iterable<_i7.EventStreakModel> get values => (super.noSuchMethod(
        Invocation.getter(#values),
        returnValue: <_i7.EventStreakModel>[],
        returnValueForMissingStub: <_i7.EventStreakModel>[],
      ) as Iterable<_i7.EventStreakModel>);
  @override
  ...
  @override
  Iterable<_i7.EventStreakModel> valuesBetween({
    dynamic startKey,
    dynamic endKey,
  }) =>
      (super.noSuchMethod(
  ...
  @override
  _i7.EventStreakModel? getAt(int? index) => (super.noSuchMethod(
        Invocation.method(
          #getAt,
          [index],
        ),
        returnValueForMissingStub: null,
      ) as _i7.EventStreakModel?);
  @override
  Map<dynamic, _i7.EventStreakModel> toMap() => (super.noSuchMethod(
        Invocation.method(
          #toMap,
          [],
        ),
        returnValue: <dynamic, _i7.EventStreakModel>{},
        returnValueForMissingStub: <dynamic, _i7.EventStreakModel>{},
      ) as Map<dynamic, _i7.EventStreakModel>);
  @override
  ...
  @override
  _i3.Future<void> putAll(Map<dynamic, _i7.EventStreakModel>? entries) =>
      (super.noSuchMethod(
        Invocation.method(
          #putAll,
          [entries],
  ...
  @override
  _i3.Future<int> add(_i7.EventStreakModel? value) => (super.noSuchMethod(
        Invocation.method(
          #add,
          [value],
        ),
  ...
  @override
  _i3.Future<Iterable<int>> addAll(Iterable<_i7.EventStreakModel>? values) =>
      (super.noSuchMethod(
        Invocation.method(
          #addAll,
          [values],
